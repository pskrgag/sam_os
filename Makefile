...
BINARY = target/$(TARGET)/debug/rust_os
...
qemu:
	~/Documents/kernel_workspace/qemu/build/qemu-system-aarch64 -d mmu,guest_errors -D test.txt -machine virt,gic-version=2 -m 2048M -cpu cortex-a53 -nographic -kernel $(BINARY)
