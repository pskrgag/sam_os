...
macro_rules! percpu_global {
    ($(#[$attr:meta])* static $N:ident : $T:ty = $e:expr;) => {
        ...
        $(#[$attr])* static $N : $crate::smp::PerCpu<$T> = $crate::smp::PerCpu::new($e);
    };

    ($(#[$attr:meta])* pub static $N:ident : $T:ty = $e:expr;) => {
        #[unsafe(link_section = ".percpu.data")]
        $(#[$attr])* pub static $N : $crate::smp::PerCpu<$T> = $crate::smp::PerCpu::new($e);
    };

    ($(#[$attr:meta])* pub static mut $N:ident : $T:ty = $e:expr;) => {
        #[unsafe(link_section = ".percpu.data")]
        $(#[$attr])* pub static mut $N : $crate::smp::PerCpu<$T> = $crate::smp::PerCpu::new($e);
    };

    ($(#[$attr:meta])* static mut $N:ident : $T:ty = $e:expr;) => {
        #[unsafe(link_section = ".percpu.data")]
        $(#[$attr])* static mut $N : $crate::smp::PerCpu<$T> = $crate::smp::PerCpu::new($e);
    };
}
